...
class DataSplittingStrategy(ABC):
    @abstractmethod
    def split_data(self, df: pd.DataFrame, target_column: str, exclude_columns: list = None):
        """
        ...
        exclude_columns (list, optional): List of column names to exclude from predictors.
...
class SimpleTrainTestSplitStrategy(DataSplittingStrategy):
    ...
    def split_data(self, df: pd.DataFrame, target_column: str, exclude_columns: list = None):
        ...
        # Drop target column and any additional columns to exclude
        cols_to_drop = [target_column] + (exclude_columns if exclude_columns is not None else [])
...
class DataSplitter:
    ...
    def split(self, df: pd.DataFrame, target_column: str, exclude_columns: list = None):
        """
        ...
        return self._strategy.split_data(df, target_column, exclude_columns)
