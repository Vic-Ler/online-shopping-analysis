...
# --------------------------------------------
# This strategy inspects the data types of each column.
...
# -----------------------------------------------------
# This strategy provides the dataset shape details.
class DatasetShapeInspectionStrategy(DataInspectionStrategy):
    def inspect(self, df: pd.DataFrame):
        ...
        Returns:
        None: Prints shape of the dataset to the console.
        """
        print("\nDataset Shape: ")
        print(df.shape)

# Concrete Strategy for Unique Type Inspection
# -----------------------------------------------------
# This strategy provides the number of unique types per column.
class UniqueTypeInspectionStrategy(DataInspectionStrategy):
    def inspect(self, df: pd.DataFrame):
        """
        Prints number of unique types per column.

        Parameters:
        df (pd.DataFrame): The dataframe to be inspected.

        Returns:
        None: Prints number of unique types per column to console.
        """
